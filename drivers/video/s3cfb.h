...
#define S3CFB_PIXEL_BPP_16	16	
#define S3CFB_PIXEL_BPP_24	24	
#define S3CFB_PIXEL_BPP_28	28	
...
#define S3CFB_PALETTE_BUFF_CLEAR	(0x80000000)	
...
typedef struct {
	...
	u_char *		screen_cpu_f1;	
	dma_addr_t		screen_dma_f1;	
