...
/* GPB-3 is ChipSelect(Active Low) of Slave-0 connected to Bus-0 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5PC1XX_GPB(3), S5PC1XX_GPB_OUTPUT(3), 0, 0);
/* GPA1_2(CON7-pin10 on SMDK base b/d) is ChipSelect(Active Low) of Slave-1 connected to Bus-0 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5PC1XX_GPA1(2), S5PC1XX_GPA1_OUTPUT(2), 0, 1);
#endif

#if defined(CONFIG_SPI_CNTRLR_1)
/* GPB-7 is ChipSelect(Active Low) of Slave-0 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5PC1XX_GPB(7), S5PC1XX_GPB_OUTPUT(7), 1, 0);
/* GPA1_3(CON7-pin11 on SMDK base b/d) is ChipSelect(Active Low) of Slave-1 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5PC1XX_GPA1(3), S5PC1XX_GPA1_OUTPUT(3), 1, 1);
/* GPD6 is ChipSelect(Active Low) of Slave-2 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5PC1XX_GPD(6), S5PC1XX_GPD_OUTPUT(6), 1, 2);
#endif
...
#endif
#ifdef CONFIG_SPI_CNTRLR_2
	samspi_set_info(2, &spi_mst_info[2]);
#endif
