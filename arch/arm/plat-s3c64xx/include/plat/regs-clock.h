...
#define S3C_NORMAL_CFG_IROM			(0x1 << 30)
#define S3C_NORMAL_CFG_DOMAIN_ETM	(0x1 << 16)
#define S3C_NORMAL_CFG_DOMAIN_S		(0x1 << 15)
#define S3C_NORMAL_CFG_DOMAIN_F		(0x1 << 14)
#define S3C_NORMAL_CFG_DOMAIN_P		(0x1 << 13)
#define S3C_NORMAL_CFG_DOMAIN_I		(0x1 << 12)
#define S3C_NORMAL_CFG_DOMAIN_G		(0x1 << 10)
#define S3C_NORMAL_CFG_DOMAIN_V		(0x1 << 9)
