...
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5P64XX_GPC(3), S5P64XX_GPC_OUTPUT(3), 0, 0);
/* GPF-13(J1-pin3 on SMDK base b/d) is ChipSelect(Active Low) of Slave-1 connected to Bus-0 */
DECLARE_SPIPDATA(sam_cs_setF13, sam_cs_configF13, CS_ACT_LOW, S5P64XX_GPF(13), S5P64XX_GPF_OUTPUT(13), 0, 1);
#endif

#if defined(CONFIG_SPI_CNTRLR_1)
/* GPC-7 is ChipSelect(Active Low) of Slave-0 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_set, sam_cs_config, CS_ACT_LOW, S5P64XX_GPC(7), S5P64XX_GPC_OUTPUT(7), 1, 0);
/* GPF-14(J1-pin2 on SMDK base b/d) is ChipSelect(Active Low) of Slave-1 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_setF14, sam_cs_configF14, CS_ACT_LOW, S5P64XX_GPF(14), S5P64XX_GPF_OUTPUT(14), 1, 1);
/* GPF-15(J1-pin1 on SMDK base b/d) is ChipSelect(Active Low) of Slave-2 connected to Bus-1 */
DECLARE_SPIPDATA(sam_cs_setF15, sam_cs_configF15, CS_ACT_LOW, S5P64XX_GPF(15), S5P64XX_GPF_OUTPUT(15), 1, 2);
#endif
