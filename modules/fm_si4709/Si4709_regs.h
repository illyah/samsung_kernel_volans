...
static inline void SYSCONFIG1_BITSET_DE_HIGH(u16 *data)
{
    switch_on_bits(data, (SYSCONFIG1_DE));
}

static inline void SYSCONFIG1_BITSET_DE_LOW(u16 *data)
{
...
static inline u8 SYSCONFIG2_GET_SEEKTH(u16 data)
{
...
static inline u8 SYSCONFIG3_GET_SKSNR(u16 data)
{
    return ( (u8) (data & 0x00F0)>>4 );
}
...
static inline u8 SYSCONFIG3_GET_SKCNT(u16 data)
{
    return ( (u8) (data & 0x000F) );
}
...
static inline u8 STATUSRSSI_BITGET_AFCRL(u16 data)
{
    return  ((u8) (0x1000 & data));
}
