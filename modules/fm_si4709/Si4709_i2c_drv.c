...
static int Si4709_probe (struct i2c_client *, const struct i2c_device_id *id);
...
static const struct i2c_device_id Si4709_drv_id_table[] = 
{
    {"Si4709", 0},
    { },
};

MODULE_DEVICE_TABLE(i2c,Si4709_drv_id_table);
...
static struct i2c_driver Si4709_i2c_driver =
{
    ...
    .id_table = Si4709_drv_id_table,
};

static int Si4709_probe (struct i2c_client *client, const struct i2c_device_id *id)
{
    int ret = 0;
