...
#define Si4709_IOC_SEEK_SNR_GET 		 _IOR(Si4709_IOC_MAGIC, 26, u8)

#define Si4709_IOC_SEEK_CNT_GET 		 _IOR(Si4709_IOC_MAGIC, 27, u8)

#define Si4709_IOC_RSSI_SEEK_TH_GET		 _IOR(Si4709_IOC_MAGIC, 28, u8)

#define Si4709_IOC_AFCRL_GET		 _IOR(Si4709_IOC_MAGIC, 29, u8)
